    ...
    <div className='bg-[url("/images/hero.jpg")] h-full w-full relative bg-no-repeat bg-center bg-cover'>
        <div className='bg-black lg:bg-opacity-50 w-full h-full pt-5 flex justify-center'>
            ...
            <div className='text-white absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] flex flex-col justify-center items-center gap-5'>
                <h1 className='text-[3rem] font-[900] w-max'>Unlimited movies, TV shows and more</h1>
                ...
                <div className='flex flex-row gap-2 items-center'>
                    <input type="text" className='h-[3.5rem] w-[25rem] bg-gray-600 bg-opacity-30 border-gray-500 border-[1px] rounded-[0.25rem] pl-4' placeholder='Email address'/>
                    <a className='bg-[#E50914] p-[0.8rem] rounded-[0.25rem] font-bold text-[1.3rem] hover:cursor-pointer tracking-widest'>Get Started &nbsp;&gt;</a>
                </div>
            </div>
        </div>
    </div>
